...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-accent-hover disabled:bg-border disabled:text-text-muted disabled:opacity-100",
        destructive:
        ...
        outline:
          "border border-border bg-transparent text-text-body shadow-xs hover:bg-accent-soft hover:text-text-primary disabled:bg-border disabled:text-text-muted disabled:opacity-100",
        secondary:
          "border border-border bg-transparent text-text-body hover:bg-accent-soft disabled:bg-border disabled:text-text-muted disabled:opacity-100",
        ghost:
          "hover:bg-accent-soft hover:text-text-primary disabled:opacity-50",
