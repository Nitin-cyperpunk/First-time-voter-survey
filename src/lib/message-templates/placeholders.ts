...
export const PREVIEW_MOCK_CONTEXT: Record<string, string> = {
  ...
  mobile: "9820144521",
  lead_id: "CI_EN_0001",
  referral_link: "https://apparelchoicestudy.netlify.app/r/ENABCD12",
  survey_link: "https://apparelchoicestudy.netlify.app/survey?t=XYZ",
  refill_link: "https://apparelchoicestudy.netlify.app/refill?t=a1b2c3d4e5f6",
  screener_refill_link:
    "https://apparelchoicestudy.netlify.app/refill?t=a1b2c3d4e5f6",
  survey_refill_link: "https://apparelchoicestudy.netlify.app/survey?t=XYZ",
  reward_amount: "₹225",
  qualified_count: "3",
